...
export const MenuIcon = (props: IconProps) => (
  <svg
    ...
    viewBox="0 0 24 24"
    stroke="currentColor"
    strokeWidth={2} // Bạn có thể chỉnh 1.5 để trông thanh mảnh hơn
  >
    <path
      strokeLinecap="round" // Bo tròn đầu dòng
      strokeLinejoin="round"
...
export const ModalCartIcon = (props: IconProps) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="80"
